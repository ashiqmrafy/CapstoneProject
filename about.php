...
<body>
  ...
  <div class="about">
        <div class="inner-section">
            <h1>About Us</h1>
            <p class="text">
            We are trying to reimagine vehicle ownership and leasing. The theory behind leasing a vehicle is similar to that of renting one – but for a longer period. 
